...
# Obtener predicciones en log
pred_m7_log <- predict(m7_loocv, df_salario)  

# Calcular RMSE en la escala original
score_m7_loocv <- RMSE(exp(pred_m7_log), df_salario$salario_hora)

# Mostrar resultado
cat("Modelo 7 - RMSE (Original):", round(score_m7_loocv, 2), "\n")
...
# Obtener predicciones en log
pred_m1_log <- predict(m1_loocv, df_salario)  

# Calcular RMSE en la escala original
score_m1_loocv <- RMSE(exp(pred_m1_log), df_salario$salario_hora)

# Mostrar resultado
cat("Modelo 1 - RMSE (Original):", round(score_m1_loocv, 2), "\n")
```
