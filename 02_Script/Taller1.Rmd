...
ggplot(df_pred, aes(x = age, y = salario, color = genero, fill = genero)) + 
...
# Guardar 
ggsave("GRÁFICO 5-PERFIL DE EDAD SALARIO PREDICHO POR GÉNERO.png", plot = p, dpi = 300, width = 8, height = 6)
