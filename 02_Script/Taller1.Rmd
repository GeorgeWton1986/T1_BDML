...
## 3. Perfil de edad-salario ---- NICOLAS Y JORGE
...
for (i in 1:repeticiones){
  ...
  betas_boot1 <- modelo_boot1$coefficients [2] #Seleccion de los nuevos betas con bootstrap
...
## 4.La brecha salarial de género. ---- ZAIRA Y LAURA
...
## 5. Predicción de ingresos---- NICOLAS Y JORGE
