...
hist(errores, 
     main = "GRÁFICO 7-DISTRIBUCIÓN DE ERRORES DE PREDICCIÓN", 
     xlab = "Error de Predicción", 
     col = "gray70", 
     border = "white", 
     font.main = 1)
# Guardar 
ggsave("GRÁFICO 7-DISTRIBUCIÓN DE ERRORES DE PREDICCIÓN.png", dpi = 300)
```
...
# Guardar 
ggsave("GRÁFICO 8-BOXPLOT DE ERRORES DE PREDICCIÓN.png", dpi = 300)
```
